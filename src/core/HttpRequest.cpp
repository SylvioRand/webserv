...
/*   Updated: 2025/09/15 14:51:48 by srandria         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void  HttpRequest::extractRequestBody(std::string& bodyPart)
{
      ...
      (this->_hasContentLength && this->_contentLength > this->_client_max_body_size))
  {
    ...
    this->handleChunkedEncoding_(bodyPart);
  else if (this->_hasBoundary)
    this->handleMultipartFormData_(bodyPart);
  else if (this->_hasContentLength)
    this->handleFixedLengthBody_(bodyPart);
}
...
void HttpRequest::extractRequestBody(const char *data, size_t len)
{
  ...
  if (_isChunked)
    handleChunkedEncoding_(data, len);
  else if (_hasBoundary)
    handleMultipartFormData_(data, len);
  else if (_hasContentLength)
    handleFixedLengthBody_(data, len);
}

void  HttpRequest::handleMultipartFormData_(const std::string& bodyPart)
{
...
void  HttpRequest::handleMultipartFormData_(const char* bodyPart, const size_t& len)
{
...
void  HttpRequest::handleChunkedEncoding_(const std::string& bodyPart)
{
...
void  HttpRequest::handleChunkedEncoding_(const char *bodyPart, const size_t& len)
{
  size_t contentSize = 0;
...
void  HttpRequest::handleFixedLengthBody_(std::string& bodyPart)
{
...
void  HttpRequest::handleFixedLengthBody_(const char *bodyPart, const size_t& len)
{

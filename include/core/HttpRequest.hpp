...
/*   Updated: 2025/09/15 11:56:11 by srandria         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class HttpRequest
{
  ...
  private:
    ...
    void  handleMultipartFormData_(const std::string& bodyPart);
    void  handleMultipartFormData_(const char *bodyPart, const size_t& len);
    void  handleChunkedEncoding_(const std::string& bodyPart);
    void  handleChunkedEncoding_(const char *bodyPart, const size_t& len);
    void  handleFixedLengthBody_(std::string& bodyPart);
    void  handleFixedLengthBody_(const char *bodyPart, const size_t& len);
